    ...
    `Olá, equipe StarPro!\n\n` +
      ...
      items
        .map((it) => {
          ...
          return `- ${it.name} (${it.model}) | Qtd: ${
            it.qty
          } | Unit: R$ ${unit.toLocaleString("pt-BR")}`;
        })
        .join("\n") +
        ...
        <section className={styles.card}>
          ...
          {customerType === "regular" && (
            <div className={styles.badgeOk}>
              Cliente regular — desconto aplicado automaticamente
            </div>
          )}
          ...
          <ol className={styles.ol}>
            <li>
              Clique em <strong>Baixar PDF</strong>.
            </li>
          ...
          {!canDownload && (
            <p className={styles.warn}>
              Adicione itens no carrinho para gerar o PDF.
            </p>
          )}

          <hr className={styles.hr} />

          <h2 className={styles.h2}>2) Enviar por email</h2>
          <ol className={styles.ol}>
            <li>
              Clique em <strong>Abrir email</strong>.
            </li>
          ...
          {!canEmail && (
            <p className={styles.warn}>
              Preencha pelo menos o email para gerar a mensagem.
            </p>
          )}
